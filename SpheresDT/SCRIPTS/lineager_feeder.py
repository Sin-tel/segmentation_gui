...
def generate_lineager_input_files(param_xml,filehandler):
    ...
    def read_parms(param_xml):
        ...
        return INPUT_FILE, MAKE_IMAGE_SEQUENCE,img_raw_file
    ...
    def write_lineage_file_prev():
        filehandler.d_save_info['f_name'] = 't{0}-nuclei'.format(str(nb_time_prev).rjust(3,'0'))
    ...
    INPUT_FILE, MAKE_IMAGE_SEQUENCE,img_raw_file = read_parms(param_xml)
