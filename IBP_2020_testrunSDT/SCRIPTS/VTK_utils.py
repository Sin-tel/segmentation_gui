...
def get_data_array(poly, field_type="CELL", attribute='parentIndex'):
	""" get back a point or cell data array """
	if field_type == "CELL":
	   return dsa.WrapDataObject(poly).CellData[attribute]
	elif field_type == "POINT":
		return dsa.WrapDataObject(poly).PointData[attribute]
